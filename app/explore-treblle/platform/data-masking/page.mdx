...
This feature is integrated into all [Treblle SDKs](/integrate-treblle/integrations) to ensure data masking happens at the programming level before any API request leaves your server.
...
For instructions on customizing masked fields for your programming language or framework, refer to the [SDK documentation](/integrate-treblle/integrations) in the integrations section.
