...
metaTitle: "Default Alerts & Notifications - Treblle Documentation"
...
- **Member additions**: Alerts when new team members join workspaces or API
...
<ImageCard src="/platform/default-alerts/treblle-notifications.jpg" alt="In-App Notifications" />
...
<ImageCard src="/platform/default-alerts/email.jpg" alt="Email Notifications" />
...
<ImageCard src="/platform/default-alerts/slack-integration.png" alt="Slack Integration" />
...
For more advanced notification customization, see our [Custom Alerts documentation](/explore-treblle/platform/alerts/custom-alerts).
