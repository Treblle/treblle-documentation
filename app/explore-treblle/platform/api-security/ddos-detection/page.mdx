...
<Checklist>
    ...
    <Checklist.item id="ip-monitoring">**Monitor IP Reputation** - Use Treblle's [Risky IPs](/explore-treblle/platform/api-security/ip-security) feature and implement automatic blocking</Checklist.item>
    <Checklist.item id="custom-alerts">**Set Up Custom Alerts** - Create [Custom Alerts](/explore-treblle/platform/alerts/custom-alerts) for traffic spikes and configure immediate notifications</Checklist.item>
</Checklist>
...
<InfoCards>
    <InfoCard type="group">
        <InfoCard.title>
            <Link href="/explore-treblle/platform/api-security/ip-security">IP Address Security</Link>
        </InfoCard.title>
        <InfoCard.description>
    ...
    <InfoCard type="group">
        <InfoCard.title>
            <Link href="/explore-treblle/platform/api-security/request-information">Request Information</Link>
        </InfoCard.title>
        <InfoCard.description>
