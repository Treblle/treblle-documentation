---
title: "API Endpoints"
metaTitle: "Track API Endpoints & Performance - Treblle Documentation"
...
- **Add to Docs**: Select **INCLUDE IN DOCS** from the dropdown menu. This makes the endpoint and its details visible in the api's auto-generated API documentation.

- **Remove from Docs**: Select **REMOVE FROM DOCS** to hide the endpoint from the API documentation.

### Mute or Unmute an Endpoint

- **Mute**: Requests to the endpoint will no longer appear in your api, and alerts for that endpoint will stop. Click Mute in the dropdown menu to enable this.
...
- Remove the endpoint from the api by selecting **Delete** in the dropdown menu. 
