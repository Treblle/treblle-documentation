---
title: "API Insights"
metaTitle: "API Insights Setup & Best Practices - Treblle Documentation"
...
<ImageCard src="/platform/api-insights/dashboard.png" alt="API Insights Dashboard" />
...
<ImageCard src="/platform/api-insights/demo.png" alt="Demo API Analysis" />
...
<ImageCard src="/platform/api-insights/vs-code.png" alt="VS Code Extension" />
...
<ImageCard src="/platform/api-insights/demo-1.gif" alt="VS Code Demo" />
...
<ImageCard src="/platform/api-insights/demo-3.gif" alt="Re-check Score Demo" />
...
<NoteCard>
To use API Insights GitHub action with your api. Please visit the [marketplace](https://github.com/treblle/treblle-cli).
</NoteCard>
...
<ImageCard src="/platform/api-insights/macos-app.png" alt="MacOS App" />
...
<ImageCard src="/platform/api-insights/api-score.png" alt="AI Ready Badge" />
