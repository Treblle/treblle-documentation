...
<InfoTable title="Plan" description="Cost & Features">
    <InfoTable.Row
        title="Free - $0/month"
        description="Individual developers and small teams. 1 API Dashboard, 250K requests, 7 days retention, community support"
    />
    <InfoTable.Row
        title="Starter - $30/month"
        description="Individuals and small teams seeking more API usage. 5 API Dashboard, 5M requests, 15 days retention, email support"
    />
    <InfoTable.Row
        title="Team - $300/month"
        description="Small and mid-size teams building and maintaining APIs. 10 API Dashboard, 50M requests, 30 days retention, priority support"
    />
    <InfoTable.Row
...
- **API Limits**: You may need to archive or delete apis
