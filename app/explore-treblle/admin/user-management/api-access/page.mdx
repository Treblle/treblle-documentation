...
<NoteCard>
**Automatic Access for Customer Users**: Users assigned the Customer role have special access behavior with dual visibility:
- **Complete API Documentation**: Full specs for APIs containing their customer ID
- **Filtered Usage Data**: Request history strictly limited to their customer ID
</NoteCard>

<ImageCard src="/platform/people/workspace.jpg" alt="Customer workspace showing only relevant APIs" />
...
<ImageCard src="/platform/people/dashboard.jpg" alt="Customer dashboard showing metrics and analytics" />

**Full Documentation Access (for relevant APIs):**
- Complete API specifications for APIs where their customer ID appears
...
<ImageCard src="/platform/people/docs.jpg" alt="Customer API documentation interface" />

**Limited Usage Access (Their Data Only):**
- Request history containing their customer ID
- Performance metrics for their requests
- Error logs for their requests
- Usage analytics for their API consumption
- Device and location information for their requests

<ImageCard src="/platform/people/requests.jpg" alt="Customer request history showing only their requests" />

**No Access To:**
- APIs where their customer ID has never appeared
- Other customers' request data
- Workspace-level aggregate metrics
- Other customers' usage patterns
- Internal API performance benchmarks

**Automatic Discovery:**
- Customer visibility updates dynamically as new requests arrive
- No manual configuration needed
- APIs become visible when first request with customer ID is received
- Customer ID must be passed in the `treblle-metadata` header:

<ImageCard src="/platform/people/metadata.jpg" alt="Example of treblle-metadata header format" />
```javascript
...
For all other user roles (Owner, Member, custom roles), standard API access rules apply and must be configured explicitly.
