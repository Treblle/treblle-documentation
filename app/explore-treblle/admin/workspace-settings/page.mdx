...
metaTitle: "Configure Treblle Workspace Settings - Treblle Documentation"
...
<ImageCard src="/platform/workspace-settings/workspace-details.jpg" alt="Workspace Details" />
...
- **Naming Guidelines**: Choose descriptive names that reflect your organization or API
...
<ImageCard src="/platform/workspace-settings/sdk-and-id.jpg" alt="SDK and ID" />
...
<ImageCard src="/platform/workspace-settings/share-feature.jpg" alt="Share Feature" />
...
<ImageCard src="/platform/workspace-settings/workspace-options.jpg" alt="Workspace Options" />
