---
title: "API Catalog - Treblle Documentation"
...
<TipCard>
You can interact with your API documentation more effectively using <Link href="https://treblle.com/product/alfred" target="_blank">Alfred</Link>, the AI assistant.
</TipCard>

Alfred helps you navigate and understand your API docs, making it particularly useful for new team members. 

Learn more about what's new in the <Link href="https://blog.treblle.com/whats-new-treblle-3-0-api-catalog/" target="_blank">API catalog in Treblle 3.0 Blog</Link>.
