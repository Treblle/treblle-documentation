...
**Skipped Requests:**
```
[TREBLLE DEBUG] Request skipped: Missing SDK Token or API Key configuration
[TREBLLE DEBUG] Request skipped: Filtered out (static asset)
[TREBLLE DEBUG] Request skipped: Response content type not tracked (text/html)
```
...
<appSettings>
  ...
  <add key="TrebllesdkToken" value="{Your_SDK_TOKEN}" />
</appSettings>
```
...
<NoteCard>
`TrebllesdkToken` is now called `Treblle:SdkToken`. You can find your SDK Token in the [Treblle Dashboard](https://platform.treblle.com).
</NoteCard>
...
<appSettings>
  ...
  <add key="TreblleSdkToken" value="your-sdk-token-here" />
