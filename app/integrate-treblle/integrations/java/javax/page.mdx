...
<InfoTable>
    <InfoTable.Row
        title="Java (1.8+)"
        description="Compiled with Java 8 to ensure broad compatibility."
    />
    <InfoTable.Row
        title="Servlet API (3.1.0+)"
        description="Required when using TreblleServletFilter."
    />
    <InfoTable.Row
        title="JAX-RS API (2.1.1+)"
        description="Required when using TreblleContainerFilter."
    />
</InfoTable>
...
<InfoTable>
    <InfoTable.Row
        title="sdkToken"
        description="Your Treblle SDK token. You can get this from the Treblle dashboard."
    />
    <InfoTable.Row
        title="apiKey"
        description="Your Treblle API key. You can get this from the Treblle dashboard."
    />
</InfoTable>
...
<InfoTable>
    <InfoTable.Row
        title="customTreblleEndpoint"
        description="Custom Treblle endpoint URL for self-hosted setups. Default: null"
    />
    <InfoTable.Row
        title="debugMode"
        description="Enable debug logging to log HTTP requests and responses. Default: false"
    />
    <InfoTable.Row
        title="excludedPaths"
        description="Comma-separated path patterns to exclude from tracking. Supports wildcards like /health or admin/*. Default: empty"
    />
    <InfoTable.Row
        title="maskedKeywords"
        description="Additional request/response field names to mask. Provide as comma-separated values. Default: empty"
    />
    <InfoTable.Row
        title="connectTimeoutInSeconds"
        description="HTTP connection timeout when calling the Treblle API. Default: 3 seconds"
    />
    <InfoTable.Row
        title="readTimeoutInSeconds"
        description="HTTP read timeout for Treblle API responses. Default: 3 seconds"
    />
    <InfoTable.Row
        title="maxBodySizeInBytes"
        description="Maximum request/response body size captured for telemetry. Default: 2MB (2097152 bytes)"
    />
</InfoTable>
