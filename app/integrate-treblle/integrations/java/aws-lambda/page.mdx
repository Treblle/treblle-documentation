...
First, you must create a FREE account on [treblle.com](https://treblle.com/) to get an API key and SDK Token. After you have those, you must integrate Treblle into your AWS Lambda handler.
