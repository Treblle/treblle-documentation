---
title: "Treblle with Hono"
metaTitle: "Set Up Treblle in Hono | Treblle Docs"
description: "Integrate Treblle with Hono using our official SDK to capture API requests, track errors, and secure sensitive data. Works across Node.js, Bun, and Deno runtimes."
...
To integrate Treblle with <Link href="https://hono.dev" target="_blank">Hono</Link>, we provide an official unified SDK for JavaScript frameworks - <Link href="https://github.com/Treblle/treblle-node" target="_blank">`treblle`</Link>.
...
Load the required module in your app:
...
```js copy
import { honoTreblle } from "treblle/hono";
```
</NoteCard>
