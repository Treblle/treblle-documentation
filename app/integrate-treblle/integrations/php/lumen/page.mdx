...
<InfoCard type="individual">
    <InfoCard.title>
        <Link href="https://github.com/Treblle/treblle-lumen" target="_blank">GitHub</Link>
    </InfoCard.title>
    <InfoCard.description>
        The official Treblle SDK for JavaScript frameworks including Lumen. Seamlessly integrate Treblle to manage communication with your dashboard, send errors, and secure sensitive data.
    </InfoCard.description>
</InfoCard>
...
You need an API key and SDK Token for Treblle to work. You can get those by creating a free account on [treblle.com](https://treblle.com) and your first api. You'll get the two keys which you need to add to your `.env` file like so:
