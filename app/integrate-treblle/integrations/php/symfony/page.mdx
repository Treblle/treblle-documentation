...
To install the SDK you will need to be using [Composer](https://getcomposer.org) in your api. To install it please see the [docs](https://getcomposer.org/download).
