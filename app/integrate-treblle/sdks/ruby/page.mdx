---
title: "Treblle with Ruby"
metaTitle: "Set Up Treblle in Ruby | Treblle Docs"
...
<InfoCard type="individual">
    <InfoCard.title>
        <Link href="https://github.com/Treblle/treblle-ruby" target="_blank">GitHub</Link>
    </InfoCard.title>
...
Treblle.configure do |config|
  ...
  config.sdk_token             = ENV.fetch('TREBLLE_SDK_TOKEN')
...
<InfoTable title="Option" description="Description">
    ...
    />
    <InfoTable.Row
        title="config.sdk_token"
        description="(Required) Valid SDK Token obtained after adding a new api on treblle.com"
    />
    <InfoTable.Row
