...
Next, create a FREE account on [treblle.com](https://treblle.com) to get an API key and SDK Token. After you have those simply initialize Treblle in your API code like so:
...
$treblle = TreblleFactory::create('_YOUR_API_KEY_', '_YOUR_SDK_TOKEN_');
```
