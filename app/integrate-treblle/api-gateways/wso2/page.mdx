...
2. Once logged in, create a new api by providing the following details:
   ...
   <ImageCard src="/platform/wso2/treblle-api.png" alt="Create Treblle API" />

3. After adding an API, Treblle will generate:
