...
metaTitle: "Set Up Treblle in Azure API Gateway - Treblle Documentation"
...
<InfoTable title="Policy Level" description="Scope and Use Case">
    <InfoTable.Row
        title="Global Level"
        description="Monitors all APIs in your APIM instance - Best for organization-wide visibility"
    />
    <InfoTable.Row
        title="API Level"
        description="Monitors a specific API - Best for selective monitoring"
    />
    <InfoTable.Row
        title="Operation Level"
        description="Monitors specific API operations - Best for granular control"
    />
</InfoTable>
...
1. Navigate to **APIs** in your APIM service
2. Select **All APIs** from the API list
3. Go to **Inbound processing** → **Code view**
4. Add the policy content from the repository: [Policy-Content.xml](https://github.com/Treblle/treblle-azure/blob/main/Policy-Content.xml)
5. Update the logger name to match your created logger (`treblle-logger`)
6. Click **Save**
...
1. Navigate to your **specific API** in APIM
...
<InfoTable title="Setting" description="Configuration Details">
    ...
    <InfoTable.Row
        ...
        description="Your Treblle SDK Token - Example: your-sdk-token"
    />
    <InfoTable.Row
...
<InfoTable title="Parameter" description="Configuration Details">
    <InfoTable.Row
        title="TREBLLE_SDK_TOKEN"
        description="Your Treblle SDK Token (required) - Example: your-sdk-token"
    />
    <InfoTable.Row
        title="TREBLLE_API_KEY"
