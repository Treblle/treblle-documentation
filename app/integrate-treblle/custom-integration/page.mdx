---
metaTitle: "Custom Treblle Integration – Build & Integrate Your Own - Treblle Documentation"
...
- Your framework/language isn't in our [official Integrations](/integrate-treblle/treblle-integrations)
...
Your Integration must format data according to Treblle's JSON schema and send it to the Treblle Ingress endpoint:
...
function sendToTreblle(data) {
  const endpoint = 'https://ingress.treblle.com';
