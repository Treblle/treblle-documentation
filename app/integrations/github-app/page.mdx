...
<NoteCard>
The Treblle GitHub Application requires a **Treblle Enterprise Plan**. <Link href="https://treblle.com/contact">Contact sales</Link> to upgrade your account.
</NoteCard>
...
<ImageCard src="/platform/github/install-app.jpg" alt="Install GitHub App" />
...
<ImageCard src="/platform/github/setup-token.jpg" alt="Configure Treblle Token" />
...
<ImageCard src="/platform/github/discovered-apis.jpg" alt="Discovered APIs Dashboard" />
...
<TipCard>
More frameworks are being added regularly. Check back for updates or <Link href="mailto:support@treblle.com">contact support</Link> to request support for your framework.
</TipCard>
...
<ImageCard src="/platform/github/request-review.jpg" alt="Request AI Review" />
...
<ImageCard src="/platform/github/review-results.jpg" alt="AI Review Results" />
...
<ImageCard src="/platform/github/enable-refactoring.jpg" alt="Enable Auto-Refactoring" />
...
<ImageCard src="/platform/github/pull-request.jpg" alt="Generated Pull Request" />
...
<NoteCard>
Private Cloud and On-premises deployments require a custom Enterprise agreement. <Link href="https://treblle.com/contact">Contact sales</Link> for more information.
</NoteCard>
