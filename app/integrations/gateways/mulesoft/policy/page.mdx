...
<div className="max-w-full mx-auto shadow-lg rounded-lg overflow-hidden">
  <a href="https://github.com/Treblle/treblle-mulesoft" title="View source on GitHub" aria-label="View source on GitHub" className="relative no-underline">
    <div>
    ...
    <div className="grid grid-cols-4 gap-4 px-2 py-2">
      <div className="col-span-4">
        <h3 className="text-xl font-semibold">treblle-mulesoft</h3>
        <p className="text-sm font-medium">This repository is the official Treblle custom policy for MuleSoft, which enables you to integrate Treblle to capture and monitor API traffic in your MuleSoft environment.</p>
      </div>
    </div>
  </a>
</div>
...
<ImageCard src="/platform/mulesoft/AutomatedPolicy.jpeg" alt="Automated Policies in API Manager sidebar" />
...
<ImageCard src="/platform/mulesoft/EditPolicy.jpeg" alt="Automated Policy Configuration" />
...
<ImageCard src="/platform/mulesoft/AdvanceOption.jpeg" alt="Advanced Options for Automated Policy" />
...
<ImageCard src="/platform/mulesoft/masking.png" alt="Masking fields configuration" />

This is how it will look in the Treblle dashboard:

<ImageCard src="/platform/mulesoft/treblle-masking.png" alt="Masked data in Treblle dashboard" />
...
<ImageCard src="/platform/mulesoft/tick-mask-payload.jpg" alt="Enable mask payload option" />

2. **View the masked payload** in your API requests - it will appear like this in your Treblle dashboard:

<ImageCard src="/platform/mulesoft/mask-payload.jpg" alt="Masked payload in dashboard" />
