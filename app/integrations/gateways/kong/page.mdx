  ...
  >
    ...
    <div className="grid grid-cols-4 gap-4 px-2 py-2">
      <div className="col-span-4">
        <h3 className="text-xl font-semibold">treblle-kong</h3>
        <p className="text-sm font-medium">The official Treblle plugin for Kong.</p>
      </div>
    </div>
  </a>
</div>
...
<InfoTable title="Parameter" description="Default and Description">
    ...
    <InfoTable.Row
        ...
        description="The Treblle API ID (required)"
    />
    <InfoTable.Row
