...
<InfoTable title="Section" description="Description">
    <InfoTable.Row title="Getting Started" description="Initial setup, configuration, and first API connection" />
    <InfoTable.Row title="Platform Features" description="Core functionality including monitoring, analytics and governance" />
    <InfoTable.Row title="Integrations" description="Initial setup, configuration, and first API connection" />
    <InfoTable.Row title="Onboarding Checklist" description="Complete step-by-step checklist for deploying Treblle across your organization" />
</InfoTable>
