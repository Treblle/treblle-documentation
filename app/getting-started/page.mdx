...
=======
>>>>>>> 1333964 (feat: added getting started page, and image card component)
=======
import  PaginationCards  from "~components/cards/pagination-cards";
>>>>>>> 08eb7ea (feat: added youtube embeded component, removed additional custom box component, added onborarding page note: change youtube video)
...
### Add an API
    ...
    Can't find your platform? Check our complete [integrations list](https://docs.treblle.com/integrations/).
