---
title: "Quick Start"
metaTitle: "Getting Started with Treblle - Treblle Documentation"
...
<ImageCard src="/getting-started/create-account.png" alt="Create Account" />
...
<ImageCard src="/getting-started/account-settings.png" alt="Account Settings" />
...
<ImageCard src="/getting-started/create-workspace.png" alt="Create Workspace" />

Team members can be invited to your workspace at this stage or at a later time.

<ImageCard src="/getting-started/invite-team.png" alt="Invite Team" />
...
<ImageCard src="/getting-started/home-dashboard.png" alt="Home Dashboard" />
...
<ImageCard src="/getting-started/add-new-api.png" alt="Add New API" />
...
Can't find your platform? Check our complete [integrations list](/integrate-treblle/treblle-integrations).
...
<ImageCard src="/getting-started/first-request.png" alt="First Request" />

Once integrated, Treblle automatically provides you with:

- Real-time API monitoring and logging
- Auto-generated [API documentation](/explore-treblle/platform/api-documentation/) with OpenAPI support
- [API governance scoring](/explore-treblle/platform/api-governance/dashboard)
- [API security](/explore-treblle/platform/api-security/dashboard)
- One-click testing
- API management on the go
- [Error reporting](/explore-treblle/platform/problems/)
