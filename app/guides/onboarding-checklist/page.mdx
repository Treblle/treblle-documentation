...
<IntegrationCards>
    <IntegrationCards.Card
        ...
        icon={<Puzzle className={css({ width: "16px", height: "16px", color: "atomic.200" })} />}
        link="https://docs.treblle.com/integrations/"
        linkTitle="Browse all SDKs"
    >
    ...
    <IntegrationCards.Card
        ...
        icon={<Rocket className={css({ width: "16px", height: "16px", color: "product.alfred.200" })} />}
        link="https://docs.treblle.com/integrations/"
        linkTitle="Gateway Integration Guides"
    >
        ...
        **Note:** Contact the [Treblle team](mailto:support@treblle.com) when integrating with API Gateway
        for assistance.
    </IntegrationCards.Card>
</IntegrationCards>
...
<IntegrationCards>
    ...
    <IntegrationCards.Card
        ...
        icon={<CircleCheck className={css({ width: "16px", height: "16px", color: "product.alfred.200" })} />}
    >
...
<InfoTable title="Issue" description="Solution">
    <InfoTable.Row
        title="No data appearing"
        description="Verify SDK Token/API Key are correct"
    />
    <InfoTable.Row
        title="Connection errors"
        description="Check firewall allows *.treblle.com"
    />
    <InfoTable.Row
        title="Missing requests"
        description="Ensure integration is deployed to correct environment"
    />
    <InfoTable.Row
        title="Login issues"
        description="Verify SSO configuration with IT team"
    />
</InfoTable>
