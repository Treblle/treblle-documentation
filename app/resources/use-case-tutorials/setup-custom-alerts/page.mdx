...
<NoteCard>
  This tutorial assumes you already have Treblle integrated and receiving API requests. If not, check out <Link href="/resources/use-case-tutorials/monitor-first-api">Monitor Your First API in 5 Minutes</Link> first.
</NoteCard>
