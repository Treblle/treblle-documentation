...
<NoteCard>
This tutorial assumes you're already monitoring your API with Treblle. If not, start with <Link href="/resources/use-case-tutorials/debug-production-issue/monitor-first-api">Monitor Your First API in 5 Minutes</Link>.
</NoteCard>
