---
title: "Individual API Dashboard - Treblle Documentation"
metaTitle: "Individual API Dashboard - Treblle Documentation"
...
<ImageCard src="/platform/dashboard/Individual-API-Dashboard-Full-Image.png" alt="Individual API Dashboard Overview" />
...
<ImageCard src="/platform/dashboard/Individual-API-Dashboard-Key-Metrics.png" alt="Key Metrics" />
...
- **Total Customers**: Helps understand how many new customers/ API consumers have been onboarded onto your API
...
When you're ready to investigate or drill down into any of these key metrics, you have dedicated views and more details that make it up, you can head over to the necessary section from the left-side navbar.
...
<ImageCard src="/platform/dashboard/Individual-API-Dashboard-Customise-Button.png" alt="Customize Button" />

<ImageCard src="/platform/dashboard/Individual-API-Dashboard-Customize-Dashboard.png" alt="Customize Dashboard" />
...
<ImageCard src="/platform/dashboard/time-window.png" alt="Time Window Filter" />
