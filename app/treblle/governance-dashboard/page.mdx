---
title: "API Governance - Treblle Documentation"
...
<ImageCard src="/platform/api-governance/governance.png" alt="API Governance Navigation" />

2. Overview of the API Governance dashboard.

<ImageCard src="/platform/api-governance/dashboard.png" alt="API Governance Dashboard" />

## Governance Categories

Treblle's API governance measures your APIs across four main categories:

<ImageCard src="/platform/api-governance/api-score.png" alt="API Governance Score" />
...
<ImageCard src="/platform/api-governance/ai-ready.png" alt="AI Ready Category" />
...
<ImageCard src="/platform/api-governance/design.png" alt="Design Category" />
...
<ImageCard src="/platform/api-governance/performace.png" alt="Performance Category" />
...
<ImageCard src="/platform/api-governance/security.png" alt="Security Category" />
