---
title: "Metadata - Treblle Documentation"
metaTitle: "Treblle Metadata – Correlate Business Metrics with API Data - Treblle Documentation"
...
<ImageCard src="/platform/metadata/general.jpg" alt="Treblle Metadata Header" />
...
<InfoTable title="Implementation Requirements" description="Critical guidelines for metadata implementation">
    <InfoTable.Row
        title="Header Name"
        description="The header name must be exactly `treblle-metadata`"
    />
    <InfoTable.Row
        title="Value Format"
        description="The value must be a stringified JSON using `JSON.stringify()`"
    />
    <InfoTable.Row
        title="Structure"
        description="The JSON should contain flat key-value pairs (no nested objects)"
    />
    <InfoTable.Row
        title="Size Limit"
        description="Maximum 2000 characters total for the entire stringified JSON"
    />
</InfoTable>
...
<InfoCard type="individual">
    <InfoCard.title>Trace ID Configuration</InfoCard.title>
    <InfoCard.description>
        **Field**: `trace-id`
...
<InfoCard type="individual">
    <InfoCard.title>User ID Configuration</InfoCard.title>
    <InfoCard.description>
        **Field**: `user-id`
...
<ImageCard src="/platform/metadata/general.jpg" alt="Metadata Headers Tab" />
...
<ImageCard src="/platform/metadata/metadata.jpg" alt="Metadata Tab" />

The Metadata tab displays each metadata field as a separate, easy-to-read entry:

<InfoTable title="Metadata Field Types" description="Understanding how different metadata fields are displayed">
    <InfoTable.Row
        title="Customer"
        description="Shows the `user-id` field value - this will populate the Customer Dashboard"
    />
    <InfoTable.Row
        title="Trace ID"
        description="Displays the `trace-id` for API Traceability - this groups related requests together"
    />
    <InfoTable.Row
        title="Custom Fields"
        description="All other metadata fields like `company_SAqzO`, `treblle-username`, `x-customer-id`, etc. - these can be used for filtering requests"
    />
</InfoTable>
