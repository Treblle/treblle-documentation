---
title: "API Security - Treblle Documentation"
metaTitle: "API Security - Treblle Documentation"
...
<ImageCard src="/platform/api-security/overall.png" alt="Security Overview" />

5. The overall security status of the API shows the 13 security checks with threat level.

<ImageCard src="/platform/api-security/status.png" alt="Security Status" />

6. When you click on any threat level, you will see details about it, helping you understand how to improve it.

<ImageCard src="/platform/api-security/description.png" alt="Threat Details" />
