---
title: "Custom Governance Rules - Treblle Documentation"
metaTitle: "Custom Governance Rules with Spectral - Treblle Documentation"
...
<ImageCard src="/platform/api-governance/main-settings.jpg" alt="Governance Rules in Settings" />
...
<ImageCard src="/platform/api-governance/settings.jpg" alt="Governance Settings Button" />
...
<ImageCard src="/platform/api-governance/ruleset.jpg" alt="New Ruleset Button" />
...
<ImageCard src="/platform/api-governance/governance-ruleset.png" alt="Governance Rulesets Table" />

<InfoTable title="Column" description="Description">
   <InfoTable.Row
        title="Name"
        description="Ruleset identifier (e.g., treblle-default.yaml, custom-file1.yaml)"
    />

    <InfoTable.Row
        title="Date Uploaded"
        description="When the ruleset was added to Treblle"
    />

   <InfoTable.Row
      title="Applies To"
      description="Scope of application (Workspace or specific APIs)"
   />

   <InfoTable.Row
      title="Enabled"
      description="Toggle to activate or deactivate the ruleset"
   />
