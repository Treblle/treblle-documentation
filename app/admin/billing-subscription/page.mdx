---
title: "Billing and Subscription Management - Treblle Documentation"
metaTitle: "Manage Treblle Billing & Subscriptions - Treblle Documentation"
...
<ImageCard src="/platform/billing/subscription-plans.jpg" alt="Subscription Plans" />

### Available Plans

<InfoTable title="Plan" description="Cost & Features">
    <InfoTable.Row
        title="Free - $0/month"
        description="Individual developers and small teams. 1 API Project, 250K requests, 7 days retention, community support"
    />
    <InfoTable.Row
        title="Starter - $30/month"
        description="Individuals and small teams seeking more API usage. 5 API Projects, 5M requests, 15 days retention, email support"
    />
    <InfoTable.Row
        title="Team - $300/month"
        description="Small and mid-size teams building and maintaining APIs. 10 API Projects, 50M requests, 30 days retention, priority support"
    />
    <InfoTable.Row
        title="Enterprise - Custom pricing"
        description="Organizations scaling API operations with enterprise support. Custom APIs, unlimited requests, custom retention, dedicated support and integrations"
    />
</InfoTable>
...
<ImageCard src="/platform/billing/billing-frequency.jpg" alt="Billing Frequency" />
...
<ImageCard src="/platform/billing/current-plan.jpg" alt="Current Plan" />
...
<ImageCard src="/platform/billing/manage-billing.jpg" alt="Manage Billing" />

## Billing Management with Stripe

Treblle partners with Stripe for secure and simplified billing management.

<ImageCard src="/platform/billing/stripe-billing.jpg" alt="Stripe Billing" />
...
<ImageCard src="/platform/billing/invoice-history.jpg" alt="Invoice History" />
...
<ImageCard src="/platform/billing/download-invoice.jpg" alt="Download Invoice" />
...
<ImageCard src="/platform/billing/contact-sales.jpg" alt="Contact Sales" />
