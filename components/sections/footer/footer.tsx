            ...
            <Box css={{ maxWidth: "1400px", width: "100%", paddingX: "24px" }}>
                ...
                >
                    ...
                    <Box css={{ display: "flex", gap: { base: "16px", md: "24px" } }}>
                        <Image src="/badges/GDPR.svg" alt="GDPR Badge" width={98} height={34} />
                        <Image src="/badges/soc2.svg" alt="SOC2 Badge" width={37} height={34} />
                        <Image src="/badges/ISO.svg" alt="ISO Badge" width={42} height={34} />
                        <Image src="/badges/hipaa.svg" alt="HIPAA Badge" width={72} height={34} />
                    </Box>
                </Box>
            </Box>
        </Box>
